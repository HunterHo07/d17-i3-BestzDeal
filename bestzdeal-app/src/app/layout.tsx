...
export const metadata: Metadata = {
  title: "BestzDeal - The Reverse Marketplace",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen bg-gradient-to-b from-slate-900 to-slate-950 text-white`}
      >
        <div className="flex flex-col min-h-screen">
          ...
          <footer className="bg-slate-900 border-t border-slate-800 py-8">
            <div className="container mx-auto px-4">
              ...
              <div className="mt-8 border-t border-slate-800 pt-8 text-center text-slate-400 text-sm">
